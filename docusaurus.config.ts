...
const config: Config = {
  ...
  url: 'https://gauharzaman110-dev.github.io', // IMPORTANT: Replace 'gemini-ai' with your actual GitHub username
  // Set the /baseUrl/ of your site here
  baseUrl: '/my_digital_book/', // Base URL for project sites on GitHub Pages
